<template>
  <div class="content">
    <div class="content-nav">
      ...
      <div class="nav-meat">
        <footTwo :footerOption="footerOption"></footTwo>
        <div class="nav-color">
    ...
    <template v-if="finished">
      ...
      <div style="margin: 20px auto">
        <el-button size="large" @click="submit" type="primary"
          >存为草稿</el-button
        >
        <el-button size="large" @click="submit" type="primary"
          >保存发布</el-button
...
import footTwo from "./template/footTwo";
  ...
  methods: {
    ...
    submit() {
      let _params = {
        ...
        cur_type_selected: 2,
        cur_content: localStorage.getItem("footerOptionTwo"),
