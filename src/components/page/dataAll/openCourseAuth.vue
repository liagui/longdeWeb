  ...
  <div class="courses-auth">
    ...
    >
      <div class="head">
        ...
        <el-checkbox class="auth-checked" v-model="authChecked" @change="authCheck">仅展示当前关联的课程</el-checkbox>
      </div>
...
data() {
  ...
  mounted() {
    ...
    this.searchData.school_id = this.transDataAuth.school_id;
    this.getSubjectList();
    this.initData();
    this.$nextTick(() => {
      this.authLesson();
  ...
  methods: {
    ...
    submit() {
      _request
        ...
        .then(res => {
          ...
          //   });
          //   this.$router.go(0);
          //   // this.schoolSelf.showOpenCoursesAuth = false
          // } else {
          //   this.$message({
          //     showClose: true,
          //     message: res.msg,
    ...
    initData() {
      _request
        .http(this, "courschool/courseList", this.searchData)
        .then(res => {
          this.authChecked = false;
