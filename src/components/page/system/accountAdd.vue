  ...
  <div class="container-box" style="background: '#fff'">
    <div class="accounadd cleafix">
      ...
      <div class="form-box">
        ...
        >
          ...
          <el-form-item label="密码：" prop="password">
            <!-- <el-input type="password" v-model="addData.password" placeholder="请输入密码" autocomplete="off"></el-input> -->
            <el-input
      ...
      <!-- <div class="form-box">
        ...
        >
          <el-form-item label="所属网校：">
            <el-input v-model="schoolData.name" :value="addData.school_id" disabled></el-input>
          </el-form-item>
          <el-form-item label="登录账号：" prop="username">
            <el-input v-model="addData.username" placeholder="请输入登录账号" clearable></el-input>
          </el-form-item>
          <el-form-item label="关联老师：" prop="teacher_id">
            <el-tag
              v-if="addData.teacher_id"
          ...
          <el-form-item label="姓     名：" prop="realname">
            <el-input v-model="addData.realname" placeholder="请输入姓名" clearable></el-input>
          </el-form-item>
          <el-form-item label="手机号：" prop="mobile">
            <el-input v-model="addData.mobile" placeholder="请输入手机号" clearable></el-input>
          </el-form-item>
          <el-form-item label="性 别：" prop="sex">
            <el-radio v-model="addData.sex" label="0">男</el-radio>
            <el-radio v-model="addData.sex" label="1">女</el-radio>
          ...
          <el-form-item label="选择角色：" prop="role_id">
            <template>
              <el-radio-group v-model="addData.role_id" v-for="item in roleArr" :key="item.id">
                <el-radio :label="item.id">{{item.role_name}}</el-radio>
              </el-radio-group>
            </template>
            <el-button
  ...
  methods: {
    ...
    marksureFun() {
      this.$refs.addData.validate((valid) => {
        if (valid) {
          //添加
          _request
            .http(this, "adminuser/doInsertAdminUser", this.addData)
            .then((res) => {
              if (res.code == 200) {
                this.$message({
                  message: "添加成功",
    ...
    handleCheckedCitiesChange(value) {
      ...
      for (let i = 0; i < value.length; i++) {
        if (this.citschoolid.indexOf(value[i].id) == -1) {
          this.citschoolid += value[i].id + ",";
        }
      }
